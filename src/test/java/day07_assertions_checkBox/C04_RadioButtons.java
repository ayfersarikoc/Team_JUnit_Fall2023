...
public class C04_RadioButtons {
    ...
    public void radioButtonTest(){
        ...
        WebElement femaleRadioB= driver.findElement(By.xpath("//*[@*='_8esa'][1]"));
        WebElement maleRadioB= driver.findElement(By.xpath("(//*[@*='_8esa'])[2]"));
        WebElement customRadioB= driver.findElement(By.xpath("(//*[@*='_8esa'])[3]"));
       femaleRadioB.click();
        //  e. Sectiginiz radio button’un seçili, ötekilerin seçili olmadigini test edin
        Assert.assertTrue(femaleRadioB.isSelected() && !maleRadioB.isSelected() && !customRadioB.isSelected());
    }
}
